function create_menu_page() {
    ...
    menu_page_html += "<div id='pop_menu' style='position: fixed; top: 40px; right: 5px; padding: 10px; z-index: 999; border-radius: 5px; min-width: 230px; display: none;' class='bg-dark h-75'>";
    menu_page_html += "<div style='position: fixed; top: 20px; right: 10px;' class='text-dark'><i class='fa fa-caret-up fa-2x'></i></div>";
    menu_page_html += "<div style='overflow-y: auto;' class='h-100'>";
