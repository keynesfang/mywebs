function create_menu_page() {
    ...
    menu_page_html += "<div id='menu_content' style='overflow-y: auto; width: 230px; float: right; border: 1px solid #fff;' class='bg-dark'>";
    ...
    top.set_height();
    $("#menu_content").css("max-height", $("#sub_body").height() - 70);
    ...
    $(".menu_btn").click(function () {
        ...
        if (link) {
            ...
            if (typeof(after_menu_open) == "function") {
                after_menu_open();
            }
        }
        $('#pop_menu').toggle(200);
