    ...
    <script>
        ...
        var enlighten_info_detail = [
            ...
            {tab_id: "tab2", tab_name: "练习", gen_html_func: get_tab2_content_html, content_html: ""},
            {
                ...
                content_html: "",
                onclick_html: "show_video(\"tab3\", 36, \"../video/resources/\", false, \"myTab\");"
            }
        ];
        $(function () {
        ...
        function get_tab1_content_html() {
            var html = "<h5><span class='badge badge-success'>1</span> 发音规则</h5>" +
                "<ul>" +
                "<li>当双元音（两个相同字母的元音）字母为<code class='sound_word'> O </code>时；</li>" +
                "<li>此时没有什么规则，<code class='sound_word'> O </code>双元音可以发出不同的音。</li>" +
                "</ul>";
