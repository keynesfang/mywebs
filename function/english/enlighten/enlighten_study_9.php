    ...
    <script>
        ...
        var enlighten_info_detail = [
            ...
            {tab_id: "tab2", tab_name: "练习", gen_html_func: get_tab2_content_html, content_html: ""},
            {
                ...
                content_html: "",
                onclick_html: "show_video(\"tab3\", 30, \"../video/resources/\", false, \"myTab\");"
            }
        ];
        $(function () {
        ...
        function get_tab0_content_html() {
            var html = "" +
                "<ul class='m-0'>" +
                "<li class='li_line_height'>了解含两个元音字母单词规则</li>" +
                "<ul>";
        ...
        function get_tab1_content_html() {
            var html = "<h5><span class='badge badge-success'>1</span> 发音规则</h5>" +
                "<ul>" +
                "<li>当一个单词中有两个元音字母，且最后一个字母以元音<code class='sound_word'> E </code>结尾时；</li>" +
                "<li>结尾的元音<code class='sound_word'> E </code>不发音；</li>" +
                "<li>另一个元音发长元音。</li>" +
                "</ul>";
